...
ok('rewritten --target absolute (wrapper)', isPrismHookCommand('bash C:/fixture-home/.claude/hooks/lib/prism-exec.sh C:/fixture-home/.claude/hooks/prism-hook.mjs'));
ok('rewritten --target absolute (legacy)', isPrismHookCommand('bash C:/fixture-home/.claude/hooks/prism-session-end.mjs'));
ok('backslash path (legacy)', isPrismHookCommand('bash C:\\fixture-home\\.claude\\hooks\\prism-session-end.mjs'));
