...
const ROUTES = {
  Write:     [['prism-kb-autosync.mjs','run'],['prism-agent-write-register.mjs','run'],['prism-skill-write-register.mjs','run'],['prism-phase-0d-challenges.mjs','run'],['prism-phase-0d-oob.mjs','run'],['prism-panel-guard.mjs','runPostToolUse']],
  Edit:      [['prism-kb-autosync.mjs','run'],['prism-agent-write-register.mjs','run'],['prism-skill-write-register.mjs','run']],
  MultiEdit: [['prism-kb-autosync.mjs','run'],['prism-agent-write-register.mjs','run'],['prism-skill-write-register.mjs','run']],
