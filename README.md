...
- 16 hooks in `~/.claude/hooks/`: classifier router, 7 enforcement guards, lifecycle (session-start/end, subagent-stop), 4 advisory hooks, agent-write auto-fire registrar (v3.11.0)
